...
namespace WebStorage.Controllers
{
    public class StoragesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StorageId,Title,Location")] Storage storage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StorageId,Title,Location")] Storage storage)
        {
            if (ModelState.IsValid)
            {
